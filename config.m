...
try
    ...
    warning(ME.identifier, "Pipeline config load failed: %s", ME.message);
end
...
try
    ...
    warning(ME.identifier, "Params load/apply failed: %s", ME.message);
    params = struct();
end
...
try
    ...
    warning(ME.identifier, "Knobs load/apply failed: %s", ME.message);
    C.knobs = struct();
end
